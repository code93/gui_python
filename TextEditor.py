...
def open_file():
    ...
    try:
        ...
        print("Open Operation Canceeled")
        return
...
def show_about_info():
    messagebox.showinfo(
        title="About",
        message="The Text Editor has been developed in Python by Shubham Birmi."
    )

root = tk.Tk()
root.title("Pdf Structuring")
...
# tk.Label(main, text = "Header", bg="green").pack(side="top", fill="both")
tk.Label(main, text="Text Editor @2021", bg="grey").pack(side="bottom", fill="both")

# tk.Label(main,text="Menu", bg="yellow").pack(side="left",fill="both")
# tk.Label(root,text="Menu", bg="yellow").pack(side="left",fill="both")
# tk.Label(root,text="Menu", bg="yellow").pack(side="left",fill="both")
# tk.Label(main,text="Body", bg="red").pack(side="top",fill="both", expand=True)
